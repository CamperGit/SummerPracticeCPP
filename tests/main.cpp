...
int main(int argc, char *argv[])
{
    ...
    Message mes1("1",sendDateTime1,"a","sender","receiver");
    Message mes2("2",sendDateTime2,"b","sender2","receiver2");
    Message mes3("3",sendDateTime3,"c","sender3","receiver3"); // 2 1 3 4
    Message mes4("4",sendDateTime4,"d","sender4","receiver4"); //3 2 4 1
